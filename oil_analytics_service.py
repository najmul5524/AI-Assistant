...
4. Explicit Catalyst Detailing: In Section 2, DO NOT write a single vague narrative paragraph. Every key news item must be EXPLICITLY and SEPARATELY presented with:
   ...
   - ⌛ Impact Expiry Horizon (কখন/কতদিন পর প্রভাব শেষ বা স্তিমিত হবে)
    - 🔄 Next Follow-up Schedule (পরবর্তী ফলো-আপে অবশ্যই সুনির্দিষ্ট তারিখ ও সময় - Date and Time in BST উল্লেখ করতে হবে, যেমন: ২৯ সেপ্টেম্বর ২০২৬, মঙ্গলবার রাত ০৮:৩০ PM BST; কেবল সাধারণ বিবরণ নয়)
...
2. ⏳ **ঘটনাগুলোর পর্যায়ক্রমিক ও কালানুক্রমিক গতিপথ (Sequential Catalyst Trajectory - গত ৭ থেকে ৩০ দিনের সক্রিয় প্রভাবক):**
   ...
   - প্রতিটি খবরের জন্য: শিরোনাম, ⌛ ইমপ্যাক্ট মেয়াদ ও 🔄 পরবর্তী ফলো-আপ (সুনির্দিষ্ট তারিখ ও সময় - Date and Time in BST)।
   ...
   - প্রতিটি খবরের জন্য: শিরোনাম, প্রাইস প্রতিক্রিয়া, ⌛ ইমপ্যাক্ট মেয়াদ ও 🔄 পরবর্তী ফলো-আপ (সুনির্দিষ্ট তারিখ ও সময় - Date and Time in BST)।
   ...
   • 📰 **[তারিখ ও সময় - BST] | [উৎস ও ইমপ্যাক্ট: যেমন 🔴 HIGH / Forex Factory / Reuters / WSJ]:**
     ...
     - 🔄 **পরবর্তী ফলো-আপ (সুনির্দিষ্ট তারিখ ও সময় - Date and Time in BST):** এই খবরের ধারাবাহিকতায় পরবর্তী অফিশিয়াল মিটিং, পলিসি সিদ্ধান্ত বা ফলো-আপ ডেটা রিলিজের সুনির্দিষ্ট তারিখ ও সময় বাংলাদেশ সময় অনুযায়ী (যেমন: ২৯ সেপ্টেম্বর ২০২৬, মঙ্গলবার রাত ০৮:৩০ PM BST)। কেবল সাধারণ বিবরণ নয়, অবশ্যই সুনির্দিষ্ট দিন, তারিখ ও সময় উল্লেখ থাকবে।
