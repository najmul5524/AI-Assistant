...
Write a comprehensive, authoritative, and structured multi-page report in fluent Bengali (বাংলা ভাষায় পূর্ণাঙ্গ ও প্রাতিষ্ঠানিক এক্সিকিউটিভ রিপোর্ট লিখুন).
Structure with standard markdown headings (##, ###) and clean bullet points:
...
- সারাদিনের মূল অর্থনৈতিক ঘটনা, ফেডারেল রিজার্ভ ও কেন্দ্রীয় ব্যাংকগুলোর অবস্থান।
- ওয়াল স্ট্রিট ও সোশ্যাল ট্রেডারদের (X.com) বর্তমান সেন্টিমেন্ট ও সামগ্রিক দৃষ্টিভঙ্গি।
...
- **Gold (XAU/USD):**
  ...
  - **মূল অনুঘটক (Catalysts):** কেন এই মুভমেন্ট প্রত্যাশিত (Yields, Dollar Index, নিরাপদ বিনিয়োগ চাহিদা)
  - **ট্রেডিং অ্যাকশন প্ল্যান:** কোন লেভেল ভাঙলে বাই বা সেল সুযোগ
- **Silver (XAG/USD):**
  - সাপোর্ট, রেজিস্ট্যান্স এবং প্রত্যাশিত গতিপথ
...
- **S&P 500 Futures (US500):**
  - সামগ্রিক মার্কিন ইকুইটি মার্কেট সেন্টিমেন্ট, আর্নিংস ও রিস্ক-অন/রিস্ক-অফ প্রবাহ
- **US Crude Oil Futures (WTI / Brent):**
  - তেলের প্রত্যাশিত রেঞ্জ ও ওপেক/ভূ-রাজনীতি প্রভাব
- **US 10-Year Treasury Yields & DXY:**
  - বন্ড ইল্ড এবং ডলার ইনডেক্সের ভবিষ্যৎ গতিপথ

## ৪. প্রধান ফরেক্স পেয়ার পূর্বাভাস (Forex Majors Roadmaps)
- **Euro (EUR/USD):** আগামীকালের লন্ডন ও নিউইয়র্ক সেশনের রোডম্যাপ, সাপোর্ট ও রেজিস্ট্যান্স
- **British Pound (GBP/USD):** ব্যাংক অব ইংল্যান্ড ও যুক্তরাজ্যের ডাটাভিত্তিক দিকনির্দেশনা
- **Japanese Yen (USD/JPY):** ইয়েনের গতিপথ এবং আপসাইড/ডাউনসাইড টার্গেট
- **Commodity Currencies (USD/CAD & AUD/USD):** কমোডিটি ও সেন্ট্রাল ব্যাংক পলিসি পূর্বাভাস

## ৫. রিস্ক ম্যানেজমেন্ট ও ইনভ্যালিডেশন গাইড (Trading Strategy & Risk)
- কোন কী লেভেল ভেঙে গেলে এই পূর্বাভাস বাতিল হবে এবং স্টপ লস ও ক্যাপিটাল সুরক্ষার প্রাতিষ্ঠানিক কৌশল।

Use rigorous financial terminology, clean structure, and insightful analysis. Do not use raw emojis in headers."""
